<?php
/*
Plugin Name: No Email Harvesting
Plugin URI: http://wordpress.org/extend/plugins/no-email-harvesting
Description: No more spam! Example usage: [no-email-harvesting email="bob@company.com"] -- See plugin site for more examples.
Version: 1.3.1
Author: marketingloads
License: GPL2
*/
 ...
 * Translation support
 **/
load_plugin_textdomain('no-email-harvesting', false, basename( dirname( __FILE__ ) ) . '/languages' );
...
class EOS
{
    ...
    static function obfuscate_shortcode($args)
    {
        ...
        (
            ...
            (
                ...
                (
                   ...
                   'noscript_message' => __("Please enable JavaScript to see this field.", "no-email-harvesting")
                ),
                $args
            )
        );
        ...
        if(!$email)
            return __("You have not entered an email address for this shortcode.", "no-email-harvesting");
        else
        {        
